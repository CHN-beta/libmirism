// when included before logger, only Atomic<ValueType, false> is defined.
# ifndef MIRISM_ATOMIC_NOLOG_HPP_INCLUDED
# define MIRISM_ATOMIC_NOLOG_HPP_INCLUDED
...
// if include after logger
# if(!defined(MIRISM_ATOMIC_HPP_INCLUDED) && defined(MIRISM_LOGGER_INCLUDED))
#	define MIRISM_ATOMIC_HPP_INCLUDED
